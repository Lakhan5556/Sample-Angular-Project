package ajb.server.resource;

import ajb.server.enumeration.Status;
import ajb.server.model.Response;
import ajb.server.model.Server;
import ajb.server.service.implementation.ServerServiceImpl;
